...
For GEPA runs, prefer `data/train/articles_with_text.jsonl` when available. It is generated by `scripts/scrape_article_text.py` and keeps the original `data/train/articles.jsonl` unchanged.
