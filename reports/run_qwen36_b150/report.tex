...
\title{GEPA Prompt Evolution Analysis\\\large Run: \texttt{run\_qwen36\_b150}}
...
Iterations logged            & 14 \\
Reflection LM calls          & 14 \\
Seed prompt words            & 92 \\
Best candidate words         & 748 \\
Word-count growth factor     & 8.13x \\
Jaccard(best, seed)          & 0.31 \\
\bottomrule
\end{tabular}
\end{center}
